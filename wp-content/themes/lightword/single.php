...
<span class="alignleft"><?php echo get_avatar( get_the_author_meta('ID'), '28' );   ?></span>
<div class="alignleft" style="width:470px;"><h4><?php _e('About','lightword'); ?> <a href="<?php the_author_url(); ?> "><?php the_author(); ?></a></h4><?php the_author_meta('description'); if(!get_the_author_meta('description')) _e('No description. Please complete your profile.','lightword'); ?></div><div class="clear"></div>
</div>
<?php endif; ?>
